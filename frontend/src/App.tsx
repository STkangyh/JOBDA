...
import { Brief } from './pages/session2/Brief'
import { Materials } from './pages/session2/Materials'
import { Workspace } from './pages/session2/Workspace'
import { SeniorFeedback } from './pages/session2/SeniorFeedback'
import { FinalFeedback } from './pages/session2/FinalFeedback'
import { BranchSelect } from './pages/session2/BranchSelect'
import { VendorCompare } from './pages/session2/VendorCompare'
import { SelfAssessment } from './pages/session2/SelfAssessment'
import { Report } from './pages/session2/Report'
import { DesignSystem } from './pages/DesignSystem'
import { Explore } from './pages/explore/Explore'
import { JobDetail } from './pages/explore/JobDetail'
import { ErrorPage } from './pages/explore/ErrorPage'
import { Session1App } from './pages/session1/Session1App'
